ValueSet: LrcOncoReferralCodes
Id: lrc-onco-referral-codes
Title: "Lrc Oncology Related referral Codes"
Description: "רשימת קודי Loinc לייצוג קודי הפניות, במסגרת טיפול אונקולוגי."
* ^url = $vs-lrc-onco-referral-codes
* ^status = #draft
* ^version = "0.1.0"
* ^experimental = false
