...
* item.productOrService.coding[moh].system = $moh-med-serv (exactly)
...
* supportingInfo[doc-ref-recommendation].information only Reference(DocumentReference)
* supportingInfo[doc-ref-recommendation].information.reference 1..1
* supportingInfo[appointment].information.type 1..1
* supportingInfo[appointment].information only Reference(Appointment)
* supportingInfo[appointment].information.reference 1..1
* supportingInfo[cov-elig-req-previous].information.type 1..1
* supportingInfo[cov-elig-req-previous].information only Reference(CoverageEligibilityRequest)
