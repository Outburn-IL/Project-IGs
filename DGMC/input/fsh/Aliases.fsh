...
Alias: $EncounterCML =                      http://fhir.health.gov.il/StructureDefinition/cml-encounter
Alias: $EncounterNamerMovement =            http://fhir.health.gov.il/StructureDefinition/namer-encounter-movement
Alias: $EncounterCase =                     http://fhir.health.gov.il/StructureDefinition/encounter-case 
...
// GENERIC
Alias: $org_sys = http://institutions.health.gov.il/Institsymbolutions
